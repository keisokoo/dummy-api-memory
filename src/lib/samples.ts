...
export const sampleAreaGroup = [
  { id: 1, name: '대구 지역 그룹 1' },
  { id: 2, name: '대구 지역 그룹 2' },
  { id: 3, name: '대구 지역 그룹 3' },
  { id: 4, name: '대구 지역 그룹 4' },
  { id: 5, name: '대구 지역 그룹 5' },
  { id: 6, name: '대구 지역 그룹 6' },
  { id: 7, name: '대구 지역 그룹 7' },
]
export const sampleSkillsGroup = [
  { id: 1, name: '도배' },
  { id: 2, name: '청소' },
  { id: 3, name: '타일' },
  { id: 4, name: '바닥' },
...
export const sampleStreets = [
  { id: 1, fullName: ['서울', '강남구', '전체'], name: '전체' },
  { id: 2, fullName: ['서울', '강남구', '신사동'], name: '신사동' },
  { id: 3, fullName: ['서울', '강남구', '논현제1동'], name: '논현제1동' },
  { id: 4, fullName: ['서울', '강남구', '논현제2동'], name: '논현제2동' },
  { id: 5, fullName: ['서울', '강남구', '논현제3동'], name: '논현제3동' },
  { id: 6, fullName: ['서울', '강남구', '삼성제1동'], name: '삼성제1동' },
  { id: 7, fullName: ['서울', '강남구', '삼성제2동'], name: '삼성제2동' },
  { id: 8, fullName: ['서울', '강남구', '삼성제3동'], name: '삼성제3동' },
  { id: 9, fullName: ['서울', '강남구', '역삼제1동'], name: '역삼제1동' },
  { id: 10, fullName: ['서울', '강남구', '역삼제2동'], name: '역삼제2동' },
  { id: 11, fullName: ['서울', '강남구', '역삼제3동'], name: '역삼제3동' },
  { id: 12, fullName: ['서울', '관악구', '전체'], name: '전체' },
  { id: 13, fullName: ['서울', '관악구', '신림동'], name: '신림동' },
  { id: 14, fullName: ['서울', '관악구', '순대1동'], name: '순대1동' },
  { id: 15, fullName: ['서울', '관악구', '순대2동'], name: '순대2동' },
  { id: 16, fullName: ['서울', '관악구', '순대3동'], name: '순대3동' },
  { id: 17, fullName: ['서울', '관악구', '곱창1동'], name: '곱창1동' },
  { id: 18, fullName: ['서울', '관악구', '곱창2동'], name: '곱창2동' },
  { id: 19, fullName: ['서울', '관악구', '곱창3동'], name: '곱창3동' },
  { id: 20, fullName: ['서울', '관악구', '역삼제1동'], name: '역삼제1동' },
  { id: 21, fullName: ['서울', '관악구', '떡볶이2동'], name: '떡볶이2동' },
  { id: 22, fullName: ['서울', '관악구', '떡볶이3동'], name: '떡볶이3동' },
  { id: 23, fullName: ['대구', '서구', '전체'], name: '전체' },
  { id: 24, fullName: ['대구', '서구', '막창1동'], name: '막창1동' },
  { id: 25, fullName: ['대구', '서구', '막창2동'], name: '막창2동' },
  { id: 26, fullName: ['대구', '서구', '막창3동'], name: '막창3동' },
  { id: 27, fullName: ['대구', '서구', '막창4동'], name: '막창4동' },
  { id: 28, fullName: ['대구', '서구', '막창5동'], name: '막창5동' },
  { id: 29, fullName: ['대구', '서구', '막창6동'], name: '막창6동' },
  { id: 30, fullName: ['대구', '서구', '막창7동'], name: '막창7동' },
  { id: 31, fullName: ['대구', '서구', '막창8동'], name: '막창8동' },
  { id: 32, fullName: ['대구', '서구', '막창9동'], name: '막창9동' },
  { id: 33, fullName: ['대구', '동구', '전체'], name: '전체' },
  { id: 34, fullName: ['대구', '동구', '똥집1동'], name: '똥집1동' },
  { id: 35, fullName: ['대구', '동구', '똥집2동'], name: '똥집2동' },
  { id: 36, fullName: ['대구', '동구', '똥집3동'], name: '똥집3동' },
  { id: 37, fullName: ['대구', '동구', '똥집4동'], name: '똥집4동' },
  { id: 38, fullName: ['대구', '동구', '똥집5동'], name: '똥집5동' },
  { id: 39, fullName: ['대구', '동구', '똥집6동'], name: '똥집6동' },
  { id: 40, fullName: ['대구', '동구', '똥집7동'], name: '똥집7동' },
  { id: 41, fullName: ['대구', '동구', '똥집8동'], name: '똥집8동' },
  { id: 42, fullName: ['대구', '동구', '똥집9동'], name: '똥집9동' },
]
