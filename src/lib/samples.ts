...
const seoulStreetSample = [
  ...
  {
    id: 3,
    fullName: ['서울', '강남구', '논현제1동'],
    name: '논현제1동',
    parent: 123,
  },
  {
    id: 4,
    fullName: ['서울', '강남구', '논현제2동'],
    name: '논현제2동',
    parent: 123,
  },
  {
    id: 5,
    fullName: ['서울', '강남구', '논현제3동'],
    name: '논현제3동',
    parent: 123,
  },
  {
    id: 6,
    fullName: ['서울', '강남구', '삼성제1동'],
    name: '삼성제1동',
    parent: 123,
  },
  {
    id: 7,
    fullName: ['서울', '강남구', '삼성제2동'],
    name: '삼성제2동',
    parent: 123,
  },
  {
    id: 8,
    fullName: ['서울', '강남구', '삼성제3동'],
    name: '삼성제3동',
    parent: 123,
  },
  {
    id: 9,
    fullName: ['서울', '강남구', '역삼제1동'],
    name: '역삼제1동',
    parent: 123,
  },
  {
    id: 10,
    fullName: ['서울', '강남구', '역삼제2동'],
    name: '역삼제2동',
    parent: 123,
  },
  {
    id: 11,
    fullName: ['서울', '강남구', '역삼제3동'],
    name: '역삼제3동',
    parent: 123,
  },
]
const seoulStreetSample2 = [
  {
    id: 12,
    fullName: ['서울', '관악구', '전체'],
    isAll: true,
  ...
  {
    id: 14,
    fullName: ['서울', '관악구', '순대1동'],
    name: '순대1동',
    parent: 124,
  },
  {
    id: 15,
    fullName: ['서울', '관악구', '순대2동'],
    name: '순대2동',
    parent: 124,
  },
  {
    id: 16,
    fullName: ['서울', '관악구', '순대3동'],
    name: '순대3동',
    parent: 124,
  },
  {
    id: 17,
    fullName: ['서울', '관악구', '곱창1동'],
    name: '곱창1동',
    parent: 124,
  },
  {
    id: 18,
    fullName: ['서울', '관악구', '곱창2동'],
    name: '곱창2동',
    parent: 124,
  },
  {
    id: 19,
    fullName: ['서울', '관악구', '곱창3동'],
    name: '곱창3동',
    parent: 124,
  },
  {
    id: 20,
    fullName: ['서울', '관악구', '역삼제1동'],
    name: '역삼제1동',
    parent: 124,
  },
  {
    id: 21,
    fullName: ['서울', '관악구', '떡볶이2동'],
    name: '떡볶이2동',
    parent: 124,
  },
  {
    id: 22,
    fullName: ['서울', '관악구', '떡볶이3동'],
    name: '떡볶이3동',
    parent: 124,
  },
]
const daeguStreetSample = [
  {
    id: 23,
    fullName: ['대구', '서구', '전체'],
    isAll: true,
...
const seoulDistrictSample = [
  { id: 123, name: '강남구', item: seoulStreetSample },
  { id: 124, name: '관악구', item: seoulStreetSample2 },
]
const daeguDistrictSample = [
  { id: 456, name: '서구', item: daeguStreetSample },
  { id: 457, name: '동구', item: daeguStreetSample2 },
]
export const citiesSample = [
  { id: 111, name: '서울', item: seoulDistrictSample },
